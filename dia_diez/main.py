...
icono = pygame.image.load("Recursos/alien.png")
pygame.display.set_icon(icono)
fondo = pygame.image.load("Recursos/espacios.png")
...
# Variables jugador
img_jugador = pygame.image.load("Recursos/rocket.png")
jugador_X = 368
jugador_y = 500
jugadorx_cambio = 0
...
img_bala = pygame.image.load("Recursos/bullet.png")
bullet_x = 0
bullet_y = 500
bullet_x_cambio = 0
bullet_y_cambio = 4
